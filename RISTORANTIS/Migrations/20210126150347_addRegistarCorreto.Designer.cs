...
namespace RISTORANTIS.Migrations
{
    ...
    [Migration("20210126150347_addRegistarCorreto")]
    partial class addRegistarCorreto
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RISTORANTIS.Models.SelecionarPFavorito", b =>
                {
                    ...
                    b.Property<DateTime?>("RegistarDataDisponibilidade")
                        .HasColumnType("datetime");

                    b.Property<int?>("RegistarIdPratoDoDia")
                        .HasColumnType("int");

                    b.Property<int?>("RegistarIdRestaurante")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RegistarDataDisponibilidade", "RegistarIdRestaurante", "RegistarIdPratoDoDia");
            ...
            modelBuilder.Entity("RISTORANTIS.Models.SelecionarServico", b =>
                {
                    b.Property<int>("ID_SelectServico")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .UseIdentityColumn();
            ...
            modelBuilder.Entity("RISTORANTIS.Models.TipoServico", b =>
                {
                    ...
                    b.Property<int?>("TipoServicoIdServico")
                        .HasColumnType("int");

                    b.HasKey("IdServico")
                        .HasName("PK__Tipo_Ser__8C3D4AF95DE75645");

                    b.HasIndex("TipoServicoIdServico");
            ...
            modelBuilder.Entity("RISTORANTIS.Models.SelecionarPFavorito", b =>
                {
                    ...
                    b.HasOne("RISTORANTIS.Models.Registar", null)
                        .WithMany("SelecionarPFavoritos")
                        .HasForeignKey("RegistarDataDisponibilidade", "RegistarIdRestaurante", "RegistarIdPratoDoDia");
            ...
            modelBuilder.Entity("RISTORANTIS.Models.TipoServico", b =>
                {
                    b.HasOne("RISTORANTIS.Models.TipoServico", null)
                        .WithMany("ts")
                        .HasForeignKey("TipoServicoIdServico");
                });
